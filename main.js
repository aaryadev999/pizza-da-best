var pizza_array = ["Veg ya..", "just chease", "Non-Veg piza(wrong spelling)", "Chicken thats all", "Chicken Dominator better"];
...
function add_item() {
    ...
    for(var i=0;i<pizza_array.length;i++) {
        pizzaval=pizzaval+'<div class="card">' + '<img src="https://freepngimg.com/thumb/pizza/34833-1-pizza-slice-transparent-background.png">' + pizza_array[i] + '</div>'
    }
